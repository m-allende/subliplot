        ...
        <div class="row mt-5 ml-3">
            ...
            <div class="col-8">
                ...
                <section class="section novi-background section-md text-center">
                    <div class="container">
                        <div id="content-services" class="row row-lg-50 row-35 offset-top-2">
            ...
            function drawServices(services) {
                if (services != null) {
                    ...
                    services.forEach(service => {
                        ...
                        if (service.last_photo != null) {
                            html +=
                                '<img src="' + service.last_photo.path +
                        ...
                        html +=
                            ' href="#">$' + parseFloat(service.last_price.price).toLocaleString("de-DE") +
                            '</a>';
                        html += ' </li>';
                        html += ' </ul> <p>' + service.description + '</p>';
